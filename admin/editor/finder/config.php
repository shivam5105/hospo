...
//$baseUrl = '/admin/uploads/editor/';
//$baseUrl = '/admin/uploads/editor/';
$baseUrl = 'http://'.$_SERVER["HTTP_HOST"].'/admin/uploads/';
...
*/
$baseDir = resolveUrl($baseUrl);
$baseDir = $_SERVER["DOCUMENT_ROOT"].'/admin/uploads/';
//$baseDir = '/home/peckies/public_html/ckfinder/userfiles/';
