...
<html>
<head>
	<title><?php echo PROJECT_NAME; ?> - Edit Template Toolbox Category</title>
...
<body>
	...
	<div class="title-row">
		<a href="<?php echo BASEURL; ?>/license_transport.php" class="button fancy title-btn primary">Manage Template Toolbox Categories</a>
		<h1 class="title">Edit New Template Toolbox Category</h1>
	</div>

	<form action="" method="post" name="add_page_form" id="add_page_form">
		<fieldset>
			<legend>Edit Template Toolbox Category</legend>
