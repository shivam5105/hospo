...
function loginCheck()
{
	...
	else if(isset($_SESSION['type']) && $_SESSION['type']!='Superadmin'){
				header('Location: '.BASEURL .'/index.php');
		die;	
		}	
...
function submit_button($text = '', $class = "", $id = "")
{
    ...
    ?>
    <div class="action">
        <input type="submit" value="<?php echo $text; ?>" name="submit" <?php if(!empty($id)) { echo 'id="'.$id.'"'; } ?> class="orange-btn <?php echo $class; ?>" /> 
    </div>
    <?php
}
